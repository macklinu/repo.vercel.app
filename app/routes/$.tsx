...
export const meta: V2_MetaFunction = ({ params }) => {
  ...
  return [{ title: `${packageName} | repo.vercel.app` }]
}
...
const GenericError = () => (
  <section className='f3 lh-copy'>
    <p data-testid='error-message'>It looks like something went wrong. 😅</p>
        ...
        return (
          <section className='f3 lh-copy'>
            <p data-testid='error-message'>
              It looks like <span className='b'>{packageName}</span>{' '}
              doesn&apos;t have a repository defined in its package.json.
            </p>
            <p>Here&apos;s how you can help! 🙏</p>
            <section className='f4 lh-copy measure'>
              <p>
      ...
      case 401:
        return (
          <section className='f3 lh-copy'>
            ...
            <section className='f4 lh-copy measure'>
              <p>
                ✅ <b>If {packageName} is private</b>, sorry, private packages
                are not supported by repo.vercel.app at this time.
              </p>
              <p>
        ...
        return (
          <section className='f3 lh-copy'>
            ...
            <section className='f4 lh-copy measure'>
              ...
              <p>
                ❌ <b>If the package does not exist</b>, sorry, I don&apos;t
